...
| :--- | :--- |
| **Lenguajes Core** | **Python** (Backend, Scripting) • **JavaScript** (Frontend, Desarrollo Web) • HTML/CSS |
...
Aquí puedes ver mis proyectos más recientes y relevantes que demuestran mi capacidad para entregar soluciones completas.
